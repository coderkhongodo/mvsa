...
parser.add_argument('--lr', type=float, default=2e-5, help='learning rate param')
parser.add_argument('--dropout', type=float, default=0.1, help='dropout param')
parser.add_argument('--warmup_steps', type=float, default=0.1, help='warmup steps or ratio (if <1, treated as ratio of total steps)')
parser.add_argument('--gradient_clip', type=float, default=1.0, help='gradient clipping value')
parser.add_argument('--scheduler', type=str, default='hf_warmup_linear', choices=['linear', 'cosine', 'warmup_cosine', 'warmup_linear', 'onecycle', 'hf_warmup_linear', 'none'], help='learning rate scheduler type')
